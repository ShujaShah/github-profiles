      ...
      <div className="w-full mx-auto lg:w-10/12 ">
          ...
          <div className="col-span-2">
            <div className="mb-6">
              ...
              <div className="mt-4 card-actions ">
                <a href={html_url} target="_blank" rel="no-referrer" className="btn btn-outline">
            ...
            <div className="w-full rounded-lg shadow-md bg-base-100 stats">
              ...
              {blog && (
                <div className="stat ">
                  ...
                  <div className="text-lg stat-value">
                    <a href={`https://${blog}`} target="_blank" rel="no-referrer">
                      {blog}
                    </a>
                  </div>
                </div>
              ...
              {twitter_username && (
                <div className="stat ">
                  ...
                  <div className="text-lg stat-value">
                    <a href={`https://twitter.com/${twitter_username}`} target="_blank" rel="no-referrer">
                      {twitter_username}
                    </a>
                  </div>
                </div>
        ...
        <div className="width-full py-5 mb-6 rounded-lg shadow-md bg-base-100 stats">
          ...
          <div className="stat">
            ...
            <div className="stats-title pr-5">Public Gist</div>
